    ...
    <div className="max-w-4xl mx-auto px-6 text-center">
      ...
      <div className="mb-12">
        ...
        <p
          ...
          style={{ color: 'var(--color-maritime-fog)' }}
        >
          Dermine your site&apos;s AI Readiness by running our free diagnostics
          scan. We&apos;ll audit your site based on the Lighthouse AI Readiness
          Index, identifying key indicators that make it discoverable,
          understandable, and trusted by AI Agents and services. Receive
          actionable insights and recommendations to improve your site&apos;s AI
          Readiness.
        </p>
      </div>
