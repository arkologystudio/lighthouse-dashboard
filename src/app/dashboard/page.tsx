...
const DashboardPage: React.FC = () => {
  const { user } = useAuth();
  const { activities, stats, isLoading: activitiesLoading } = useActivities();

  const stats_data = [
    {
      name: 'Total Sites',
      value: '0', // TODO: Get from actual sites count
    ...
    },
    {
      ...
      value: '0', // TODO: Get from actual products count
    ...
    },
    {
      ...
      action: 'View Details',
      trend: `+${stats?.recent_activity_count || 0}`,
      trendUp: true,
    },
  ];
    ...
    <div className="lh-page-container">
      ...
      <div id="recent-activity">
        <div className="lh-flex-between mb-6">
          ...
          {activities.length > 0 && (
            <Button variant="ghost" className="lh-text-link">
              View All
            </Button>
          )}
        </div>
        ...
        <Card className="lh-card">
          <CardContent
            className={activitiesLoading ? 'lh-card-content' : 'p-0'}
          >
            {activitiesLoading ? (
              <div className="lh-loading-inline">
                <div className="lh-spinner lh-spinner-md" />
                <span className="ml-3 lh-text-description">
                  Loading activities...
                </span>
              </div>
            ) : activities.length > 0 ? (
